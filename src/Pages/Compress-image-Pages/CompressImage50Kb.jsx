...
const CompressImageTo50KB = () => {
  ...
  const handleFileChange = (event) => {
    ...
    if (file) {
      ...
      // Determine the file extension and set the appropriate icon
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md mt-5">
      <button className='py-2 px-5 bg-blue-500 text-white absolute top-3 left-4' onClick={() => navigate('/')}>Back</button>
      <h2 className="text-center text-2xl font-bold mb-4">Compress Image to 50KB</h2>
