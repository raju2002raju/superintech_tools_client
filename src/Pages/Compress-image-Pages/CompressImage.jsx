...
const CompressImage = () => {
  ...
  <div className='max-w-3xl mx-auto'>
     <div className='flex flex-col items-center'>
      ...
      <h2 className="text-center text-2xl font-bold mb-4">Compress JPEG</h2>
     <div className='w-2/4'>
     <p className='text-center'>Compress JPEG size with the assistance of the online JPEG compressor. Simply submit the JPG file, hit the 
     “Compress JPEG” button, and download it.</p>
     </div>
     <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md mt-5">
       
       <img alt='upload_logo'  src={upload_image} className='w-60 mx-auto mb-3'/>
        <p className='text-center font-bold'>Upload Files Here..</p>
        <p className='text-center mb-3'>.JPEG .PNG .JPG</p>
      {/* Upload Section */}
      <input
        type="file"
      ...
      {compressedFile && (
        <div className="mt-4 text-center flex items-center gap-5 py-4 px-3 border">
          <img src={fileTypeIcon} alt="File Type Icon" className='w-10' />
